...
import { View, StyleSheet, Animated, Text, Image, Dimensions, Platform, KeyboardAvoidingView } from "react-native";
...
export default class WorldChat extends Component {
    ...
    componentDidMount() {
        ...
        socketRoom.on('update_messages_in_world_chat', (messages) => {
    ...
    componentWillUnmount() {
        socketRoom.off('update_messages_in_world_chat');
    }
    ...
    _onSend(messages = []) {
        ...
        socketRoom.emit('sending_message_to_world_chat', {
            _id: messages[0]._id,
            createAt: new Date(),
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    >
                        <Text style={styles.title}>Chat thế giới</Text>
                    </LinearGradient>
